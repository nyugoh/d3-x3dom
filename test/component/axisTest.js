...
test("Test Axis Component, component.axis()", function(t) {
	...
	axis.scale(5);
	t.deepEqual(axis.scale(), 5, "Changed yScale is populated");
	...
	t.deepEqual(axis.tickValues(), ["Apples", "Oranges", "Pears", "Bananas"], "Changed tickValues is populated");

	// Test tickDir getter / setter function
	t.deepEqual(axis.tickDir(), undefined, "Default tickDir is undefined");
	axis.tickDir("x");
	t.deepEqual(axis.tickDir(), "x", "Changed tickDir is populated");
